...
import { Clock, Menu, X, Palette, Sun, Moon, User, LogIn, LogOut, Settings } from "lucide-react";
...
// User Account Section Component - shows different content based on auth state
function UserAccountSection({ closeMenu }: { closeMenu: () => void }) {
    const { user } = useUser();
    ...
    return (
        <div className="sm-actions">
            ...
            <div className="sm-actions-list">
                <SignedIn>
                    ...
                    <div className="sm-user-info">
                        ...
                        <div className="sm-user-details">
                            <span className="sm-user-name">{user?.fullName || 'User'}</span>
                            <span className="sm-user-email">{user?.primaryEmailAddress?.emailAddress}</span>
                        </div>
                    </div>
                    <button
                ...
                <SignedOut>
                    <Link href="/login" className="sm-action-btn sm-action-btn--primary" onClick={closeMenu}>
                        <LogIn size={18} />
                        <span>Sign In</span>
                    </Link>
                    <Link href="/signup" className="sm-action-btn sm-action-btn--secondary" onClick={closeMenu}>
                        <User size={18} />
                        <span>Sign Up</span>
                    </Link>
                </SignedOut>
    ...
    return (
        ...
        >
            ...
            <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
                <div className="sm-prelayer" style={{ background: 'var(--theme-accent)', opacity: 0.3 }} />
                <div className="sm-prelayer" style={{ background: 'var(--theme-accent)', opacity: 0.6 }} />
            </div>
            ...
            >
                <div className="sm-panel-inner">
                    ...
                    <UserAccountSection closeMenu={closeMenu} />
                </div>
            </aside>
        </div>
    );
